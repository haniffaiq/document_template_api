...
class BeritaAcaraSerahTerimaPekerjaanPengawasan(db.Model):
    ...
    persentase_pekerjaan = db.Column(db.Numeric(5, 2), nullable=False)
    nomor_surat_dipa = db.Column(db.String(100), nullable=False)
    tanggal_surat_dipa = db.Column(db.Date, nullable=False)
    nomor_surat_kontrak = db.Column(db.String(100), nullable=False)
    tanggal_surat_kontrak = db.Column(db.Date, nullable=False)
