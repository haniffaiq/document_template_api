...
class LampiranBeritaAcaraPemeriksaanPekerjaan(db.Model):
    __tablename__ = 'lampiran_berita_acara_pemeriksaan_pekerjaan'
    ...
    project = db.relationship('Project', backref=db.backref('lampiran_berita_acara_pemeriksaan_pekerjaan', cascade='all, delete-orphan'), lazy=True)
