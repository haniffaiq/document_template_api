...
class Project(db.Model):
    ...
    tanggal_surat_bap = db.Column(db.String(255), nullable=True)
    ...
    tanggal_berita_acara_pemeriksaan_pekerjaan = db.Column(db.String(255), nullable=True)
    ...
    tanggal_surat_penunjukan_penyedia_barang_jasa_sppbj = db.Column(db.String(255), nullable=True)
    ...
    tanggal_surat_perjanjian_kontrak = db.Column(db.String(255), nullable=True)
    ...
    tanggal_nomor_akta_notaris_pihak_2 = db.Column(db.String(255), nullable=True)
